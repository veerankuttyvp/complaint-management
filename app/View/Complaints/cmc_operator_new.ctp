...
<div class="row">
	...
	<table id="index-datatables" class="table table-bordered table-hover">
		...
		<tbody>
        <?php $cnt=0;?>
		<?php foreach ($complaints as $complaint) { $cnt++;?>
			...
			<tr>
		        ...
		        <td class="hidden-xs hidden-sm"><span class="label label-inverse"><?php echo $complaint['ComplaintStatus']['status']; ?></span></td>
		            ...
		            <div class="btn-group">
                                <a href="<?php echo $this->Html->url("/complaints/view/".$complaint['Complaint']['id'],true); ?>" data-toggle="tooltip" title="View" class="btn btn-xs btn-success"><i class="icon-pencil"></i>Details</a>
