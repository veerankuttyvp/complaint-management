...
<div class="row">
	...
	//              echo $this->Form->input("complaint_priority_id",array("options"=>$complaint_priorities,"empty"=>'Select a Priority','required'=>true,"label"=>array("text"=>"Complaint Priority")));
	              ...
	              echo $this->Form->input("complaint_address",array('id' => 'complaint_address',"placeholder"=>"Address","type"=>"textarea","label"=>array("text"=>"Complaint Address")));
	              ...
	              echo $this->Form->input("source",array("type"=>"hidden","value"=>"cmc"));
...
window.onload = function() {
	...
	/* Initialize Form Validation */
     var validator = $('#ComplaintRegisterForm').validate({
