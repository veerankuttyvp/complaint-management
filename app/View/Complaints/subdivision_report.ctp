...
<div class="block block-themed">
                    ...
                    <div class="block-content block-content-flat">
                        <form action="<?php echo $this->Html->url(array('controller'=>'Complaints','action'=>'subdivision_pdf'));?>" method="post" class="form-horizontal form-bordered" onsubmit="return checkForm()">
