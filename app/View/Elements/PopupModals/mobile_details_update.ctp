    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6 class="sub-header">Update Assigned Mobile</h6>

                <?php 
                
                    echo $this->Form->create("MobileUserMobilePhone",array("url"=>array("action"=>"update_mobile","controller"=>"mobile_users")));
            
                echo $this->Form->input("mobile_phone_id",array("label"=>false,"required"=>"required","options"=>$mobiles,'value'=>$assignedMobileId ,"class"=>"form-control")); 
...
//                echo $this->Form->input("status",array("style"=>"margin-left:0px"));
                ...
                echo $this->Form->input("assignedMobileId",array("value"=>$assignedMobileId,"type"=>"hidden","name"=>"assigned_mobile"));
                echo $this->Form->input("mobile_user_id",array("value"=>$user["id"],"type"=>"hidden","name"=>"user_id"));
                ?>
                <button type="submit" class="btn btn-primary col-md-offset-10">Update</button></form>
                <!-- <h6 class="sub-header">Following are the assigned mobile number with this user:</h6>
                <table class="table table-borderless table-condensed">
                    <tr>
                        <th class="text-center">Mobile1</th>
