...
var webApp = function() {
 ...
 // Initialize DateRangePicker Advanced Demo Example
        var advancedDateRange = $('#advanced-daterangepicker');
        var advancedDateRangeSpan = $('#advanced-daterangepicker span');

        advancedDateRange.daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().add({days: -6}), 'today'],
        ...
        function(start, end) {
            advancedDateRangeSpan.html(start.toString('MMMM d, yy') + ' - ' + end.toString('MMMM d, yy'));
        });

        // Set the default content when page loads
       advancedDateRangeSpan.html("Select date range");
    };
